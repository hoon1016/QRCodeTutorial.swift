...
class MainViewController: UIViewController,QRCodeReaderViewControllerDelegate {
    ...
    @IBOutlet weak var QRbutten: UIButton!
    ...
    override func viewDidLoad() {
        ...
        QRbutten.layer.borderWidth = 3
        QRbutten.layer.borderColor = UIColor.blue.cgColor
        QRbutten.layer.cornerRadius = 10
        QRbutten.addTarget(self, action: #selector(qrcodeReaderLaunch), for: .touchUpInside)
    }
